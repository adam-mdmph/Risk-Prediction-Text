...
Available risk models were then reviewed and included based on their quality. Quality of risk model was determined according to published TRIPOD guidelines,\citet{collinsTransparentReportingMultivariable2015} prioritizing the following values:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Accuracy assessments, such as AUC, sensitivity or specificity assessments determined through internal and external validation.
\item
